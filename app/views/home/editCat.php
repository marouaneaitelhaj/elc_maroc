            ...
            <div class="col-md-8 col-lg-6 col-xl-4 m-4 offset-xl-1">
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                        <p class="lead fw-normal m-4">Edit category</p>
                    ...
                    ?>
                        ...
                        <div class="form-outline mb-4">
                            <input type="text" id="form3Example3" value="<?=$cat['nom']?>" name="libelle" class="border form-control form-control-lg" placeholder="Enter a valid email address" />
                            <label class="form-label" for="form3Example3">Name of category</label>
                        </div>

                        <div class="form-outline mb-4">
                            <textarea class="w-100 border" placeholder="Description" name="description" id="" cols="" rows=""><?=$cat['description']?></textarea>
                        </div>
